...
\begin{table}[t]
  ...
  \begin{tabular}{@{}p{0.21\linewidth}p{0.17\linewidth}p{0.10\linewidth}p{0.38\linewidth}@{}}
    \toprule
    Sequence & Source & Frames & Role \\
    \midrule
    \texttt{bmx-trees} & Course & 40 & Annotated benchmark \\
    \texttt{tennis} & Course & 50 & Annotated benchmark \\
    \texttt{wild\_video1} & Self-recorded & 190 & Real-scene success case \\
    \texttt{wild\_video2} & Self-recorded & 190 & Failure-to-improvement case \\
    \bottomrule
  \end{tabular}
...
In other words, restoration metrics are omitted for the wild videos not because they are unimportant, but because no paired clean target frames are available for a valid pixel-wise comparison.
...
\begin{figure}[t]
  \centering
  \IfFileExists{assets/wild_video1_part1_vs_part2.png}{
    \includegraphics[width=\linewidth]{assets/wild_video1_part1_vs_part2.png}
  }{
    \fbox{\rule{0pt}{1.2in}\rule{0.95\linewidth}{0pt}}
  }
  \caption{Real-scene success case on \texttt{wild\_video1}. With the same automatic masks, ProPainter produces a cleaner person removal result and more consistent background synthesis than the Part 1 baseline.}
\end{figure}
